...
Shader "Custom/DoubleAnimationAdditive"
{
	Properties
	{
		_Color ( "Tint", Color) = ( 1, 1, 1, 1 )
		_MainTex ( "Texture：", 2D ) = "white" {}
		_XSpeed( "X Speed：",Range( -40, 40 ) ) = 1
		_YSpeed( "Y Speed：",Range( -40, 40 ) ) = 1
		_AddTex ( "Addtive：", 2D ) = "white" {}
		_XAddSpeed( "X Speed：",Range( -40, 40 ) ) = 1
		_YAddSpeed( "Y Speed：",Range( -40, 40 ) ) = 1
