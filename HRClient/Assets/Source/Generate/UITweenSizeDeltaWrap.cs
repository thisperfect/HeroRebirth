...
public class UITweenSizeDeltaWrap
{
	public static void Register(LuaState L)
	{
		L.BeginClass(typeof(UITweenSizeDelta), typeof(UITween));
	...
	static int ToInit(IntPtr L)
	{
		try
		{
			...
			UITweenSizeDelta obj = (UITweenSizeDelta)ToLua.CheckObject(L, 1, typeof(UITweenSizeDelta));
			obj.ToInit();
			return 0;
		}
		catch(Exception e)
	...
	static int get_from(IntPtr L)
	{
		...
		try
		{
			...
			UITweenSizeDelta obj = (UITweenSizeDelta)o;
