...
public class UITweenLocalPositionWrap
{
	public static void Register(LuaState L)
	{
		L.BeginClass(typeof(UITweenLocalPosition), typeof(UITween));
	...
	static int ToInit(IntPtr L)
	{
		try
		{
			...
			UITweenLocalPosition obj = (UITweenLocalPosition)ToLua.CheckObject(L, 1, typeof(UITweenLocalPosition));
			obj.ToInit();
			return 0;
		}
		catch(Exception e)
	...
	static int get_from(IntPtr L)
	{
		...
		try
		{
			...
			UITweenLocalPosition obj = (UITweenLocalPosition)o;
