...
public class DragonBones_TimelineData_DragonBones_BoneFrameDataWrap
{
	public static void Register(LuaState L)
	{
		L.BeginClass(typeof(DragonBones.TimelineData<DragonBones.BoneFrameData>), typeof(DragonBones.BaseObject), "TimelineData_DragonBones_BoneFrameData");
	...
	static int get_scale(IntPtr L)
	{
		...
		try
		{
			...
			DragonBones.TimelineData<DragonBones.BoneFrameData> obj = (DragonBones.TimelineData<DragonBones.BoneFrameData>)o;
			float ret = obj.scale;
	...
	static int get_frames(IntPtr L)
	{
		...
		try
		{
			o = ToLua.ToObject(L, 1);
			DragonBones.TimelineData<DragonBones.BoneFrameData> obj = (DragonBones.TimelineData<DragonBones.BoneFrameData>)o;
			System.Collections.Generic.List<DragonBones.BoneFrameData> ret = obj.frames;
