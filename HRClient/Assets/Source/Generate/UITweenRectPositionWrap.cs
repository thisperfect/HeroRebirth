...
public class UITweenRectPositionWrap
{
	public static void Register(LuaState L)
	{
		L.BeginClass(typeof(UITweenRectPosition), typeof(UITween));
	...
	static int ToInit(IntPtr L)
	{
		try
		{
			...
			UITweenRectPosition obj = (UITweenRectPosition)ToLua.CheckObject(L, 1, typeof(UITweenRectPosition));
			obj.ToInit();
			return 0;
		}
		catch(Exception e)
	...
	static int get_from(IntPtr L)
	{
		...
		try
		{
			...
			UITweenRectPosition obj = (UITweenRectPosition)o;
