...
public class DragonBones_FrameData_DragonBones_AnimationFrameDataWrap
{
	public static void Register(LuaState L)
	{
		L.BeginClass(typeof(DragonBones.FrameData<DragonBones.AnimationFrameData>), typeof(DragonBones.BaseObject), "FrameData_DragonBones_AnimationFrameData");
	...
	static int get_prev(IntPtr L)
	{
		...
		try
		{
			o = ToLua.ToObject(L, 1);
			DragonBones.FrameData<DragonBones.AnimationFrameData> obj = (DragonBones.FrameData<DragonBones.AnimationFrameData>)o;
			DragonBones.AnimationFrameData ret = obj.prev;
