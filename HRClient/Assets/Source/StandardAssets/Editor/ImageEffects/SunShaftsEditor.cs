...
namespace UnityStandardAssets.ImageEffects
{
    ...
    class SunShaftsEditor : Editor
    {
		...
		*/
            ...
            EditorGUILayout.PropertyField (sunShaftsShader,  new GUIContent("sunShaftsShader"));
            EditorGUILayout.PropertyField (simpleClearShader,  new GUIContent("simpleClearShader"));
